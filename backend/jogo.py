...
if __name__ == "__main__":
    ...
    # Exemplo de uso com diferentes níveis:
    # "1-1" = Dificuldade 1, Classe 5 (conforme seu exemplo)
    # "2-3" = Dificuldade 2, Classe 3
    # etc.
    jogo = QuizGame(root, nivel="1-1")  # Altere o nível conforme necessário
    root.mainloop()